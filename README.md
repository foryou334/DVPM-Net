...
PCDL (Physics-informed Coordinate Distance Loss): Enhances pixel-level localization by suppressing environmental noise.

CTC-Net: A specialized calibration network that achieves an exceptional angular accuracy of 0.15° by learning direct mappings between camera and robot base frames.
...
Laboratory Data: Available in the data/ directory.
